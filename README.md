...
Introduction
==============
This repository contains Linux kernel v3.10 with STMicroelectronics MEMS sensor support. STM sensor drivers are located under the directory [drivers/iio](https://github.com/STMicroelectronics/STMems_Linux_IIO_drivers/tree/linux-3.10.y-gh/drivers/iio) organized by sensor type:

### Inertial Module Unit (IMU):

> LSM6DS3, LSM6DS3H, LSM6DSL, LSM6DSM, LSM9DS0, LSM9DS1, ISM330DLC, LSM6DSO, ASM330LHH, LSM6DSR, ISM330DHCX
...
> * Add custom events into *include/uapi/linux/iio/types.h* (follow a sample patch for kernel 3.10):

>         @@ -32,12 +32,15 @@ enum iio_event_type {
>                 IIO_EV_TYPE_ROC,
...
> * Add custom channel types *include/uapi/linux/iio/types.h* depending on the custom sensor implemented into driver (follow a sample patch for kernel 3.10):

>         @@ -29,6 +29,15 @@ enum iio_chan_type {
>                 IIO_ALTVOLTAGE,
>                 IIO_CCT,
>                 IIO_PRESSURE,
>         +       IIO_SIGN_MOTION,
