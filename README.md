...
Introduction
==============
This repository contains Linux kernel v3.14 with STMicroelectronics MEMS sensor support. STM sensor drivers are located under the directory [drivers/iio](https://github.com/STMicroelectronics/STMems_Linux_IIO_drivers/tree/linux-3.14.y-gh/drivers/iio)  organized by sensor type:
...
> * Add custom channel types *include/uapi/linux/iio/types.h* depending on the custom sensor implemented into driver (follow a sample patch for kernel 3.14):
