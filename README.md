...
Introduction
==============
This repository contains Linux kernel (v3.10, v3.14, v3.18, v4.4) with STMicroelectronics MEMS sensor support. STM sensor drivers are located under the directory [drivers/iio](link al repository)  organized by sensor type:
