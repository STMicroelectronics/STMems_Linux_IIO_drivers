...
#define ST_LIS2DW12_TAP_INT1_MASK		0x40
...
#define ST_LIS2DW12_EVENT_CHANNEL(chan_type, event_type,		\
				  event_dir)				\
{									\
	.type = chan_type,						\
	.modified = 0,							\
	.scan_index = -1,						\
	.indexed = -1,							\
	.event_mask = IIO_EV_BIT(event_type, event_dir),		\
}
...
static const struct iio_chan_spec st_lis2dw12_acc_channels[] = {
	...
	ST_LIS2DW12_EVENT_CHANNEL(IIO_ACCEL, IIO_EV_TYPE_FIFO_FLUSH,
				  IIO_EV_DIR_EITHER),
	IIO_CHAN_SOFT_TIMESTAMP(3),
};

static const struct iio_chan_spec st_lis2dw12_tap_tap_channels[] = {
	ST_LIS2DW12_EVENT_CHANNEL(IIO_TAP_TAP, IIO_EV_TYPE_THRESH,
				  IIO_EV_DIR_RISING),
};

static const struct iio_chan_spec st_lis2dw12_tap_channels[] = {
	ST_LIS2DW12_EVENT_CHANNEL(IIO_TAP, IIO_EV_TYPE_THRESH,
				  IIO_EV_DIR_RISING),
};

static const struct iio_chan_spec st_lis2dw12_wu_channels[] = {
	ST_LIS2DW12_EVENT_CHANNEL(IIO_GESTURE, IIO_EV_TYPE_THRESH,
				  IIO_EV_DIR_RISING),
};
...
iio_register_fail:
	...
	if (hw->irq > 0)
		st_lis2dw12_deallocate_fifo(hw);
