...
{
	return i2c_smbus_read_i2c_block_data(to_i2c_client(dev), addr,
					     len, data);
}
...
static int st_asm330lhh_i2c_remove(struct i2c_client *client)
{
	return st_asm330lhh_remove(&client->dev);
}
