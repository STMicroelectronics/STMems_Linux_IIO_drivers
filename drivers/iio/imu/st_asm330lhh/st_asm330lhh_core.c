...
static const struct st_asm330lhh_fs_table_entry st_asm330lhh_fs_table[] = {
	...
	[ST_ASM330LHH_ID_GYRO] = {
		...
		.fs_avl[0] = {  ST_ASM330LHH_GYRO_FS_250_GAIN, 0x0 },
		.fs_avl[1] = {  ST_ASM330LHH_GYRO_FS_500_GAIN, 0x1 },
		.fs_avl[2] = { ST_ASM330LHH_GYRO_FS_1000_GAIN, 0x2 },
		.fs_avl[3] = { ST_ASM330LHH_GYRO_FS_2000_GAIN, 0x3 },
	}
};
...
static const struct iio_chan_spec st_asm330lhh_acc_channels[] = {
	...
	ST_ASM330LHH_FLUSH_CHANNEL(IIO_ACCEL, IIO_EV_TYPE_FIFO_FLUSH,
				   IIO_EV_DIR_EITHER),
...
static const struct iio_chan_spec st_asm330lhh_gyro_channels[] = {
	...
	ST_ASM330LHH_CHANNEL(IIO_ANGL_VEL, ST_ASM330LHH_REG_GYRO_OUT_Z_L_ADDR,
			   1, IIO_MOD_Z, 2, 16, 16, 's'),
	ST_ASM330LHH_FLUSH_CHANNEL(IIO_ANGL_VEL, IIO_EV_TYPE_FIFO_FLUSH,
				   IIO_EV_DIR_EITHER),
	IIO_CHAN_SOFT_TIMESTAMP(3),
};
				       ...
				       u32 gain)
{
	...
	for (i = 0; i < ST_ASM330LHH_FS_LIST_SIZE; i++)
		if (st_asm330lhh_fs_table[id].fs_avl[i].gain == gain)
			break;

	if (i == ST_ASM330LHH_FS_LIST_SIZE)
		return -EINVAL;
