...
#define ST_ASM330LHH_REG_FIFO_WTM_MASK		0x01ff
#define ST_ASM330LHH_REG_FIFO_WTM8_MASK		BIT(0)
#define ST_ASM330LHH_REG_FIFO_STATUS_DIFF	0x03ff
...
#define ST_ASM330LHH_REG_ODR_T_BATCH_MASK	0x30
...
#define ST_ASM330LHH_REG_ST_G_MASK		(BIT(3) | BIT(2))
#define ST_ASM330LHH_REG_ST_XL_MASK		(BIT(1) | BIT(0))
...
#define ST_ASM330LHH_FLUSH_CHANNEL(ctype, etype, edir)			\
{									\
	.type = ctype,							\
	.modified = 0,							\
	.scan_index = -1,						\
