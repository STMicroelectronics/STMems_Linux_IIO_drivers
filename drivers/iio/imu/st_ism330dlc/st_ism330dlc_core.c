...
#define ST_ISM330DLC_ACCEL_FS_2G_GAIN			IIO_G_TO_M_S_2(61)
#define ST_ISM330DLC_ACCEL_FS_4G_GAIN			IIO_G_TO_M_S_2(122)
#define ST_ISM330DLC_ACCEL_FS_8G_GAIN			IIO_G_TO_M_S_2(244)
#define ST_ISM330DLC_ACCEL_FS_16G_GAIN			IIO_G_TO_M_S_2(488)
...
#define ST_ISM330DLC_GYRO_FS_245_VAL			0x00
...
#define ST_ISM330DLC_GYRO_FS_245_GAIN			IIO_DEGREE_TO_RAD(8750)
#define ST_ISM330DLC_GYRO_FS_500_GAIN			IIO_DEGREE_TO_RAD(17500)
#define ST_ISM330DLC_GYRO_FS_1000_GAIN			IIO_DEGREE_TO_RAD(35000)
#define ST_ISM330DLC_GYRO_FS_2000_GAIN			IIO_DEGREE_TO_RAD(70000)
...
static struct st_ism330dlc_fs_table {
	...
	[ST_MASK_ID_GYRO] = {
		...
		.fs_avl[0] = { .gain = ST_ISM330DLC_GYRO_FS_245_GAIN,
					.value = ST_ISM330DLC_GYRO_FS_245_VAL },
...
int st_ism330dlc_common_probe(struct ism330dlc_data *cdata, int irq)
{
	...
	for (i = 0; i < ST_INDIO_DEV_NUM; i++) {
		cdata->indio_dev[i] = iio_device_alloc(sizeof(struct ism330dlc_sensor_data));
