...
#define ST_ISM330DHCX_REG_FIFO_WTM_MASK		0x1ff
#define ST_ISM330DHCX_REG_FIFO_WTM8_MASK		BIT(0)

#define ST_ISM330DHCX_REG_FIFO_CTRL3_ADDR		0x09
#define ST_ISM330DHCX_REG_BDR_XL_MASK		0x0f
#define ST_ISM330DHCX_REG_BDR_GY_MASK		0xf0

#define ST_ISM330DHCX_REG_FIFO_CTRL4_ADDR		0x0a
#define ST_ISM330DHCX_REG_FIFO_MODE_MASK		0x07
#define ST_ISM330DHCX_REG_ODR_T_BATCH_MASK		0x30
#define ST_ISM330DHCX_REG_DEC_TS_MASK		0xc0
...
#define ST_ISM330DHCX_WHOAMI_VAL			0x6c
...
#define ST_ISM330DHCX_REG_ROUNDING_MASK		0x60
...
#define ST_ISM330DHCX_REG_FIFO_STATUS_DIFF		0x2ff
...
#define ST_ISM330DHCX_EVENT_CHANNEL(ctype, etype, edir)			\
{									\
	.type = ctype,							\
	.modified = 0,							\
	.scan_index = -1,						\
...
#define ST_ISM330DHCX_EF_DATA_CHANNEL(chan_type, mod, ch2, scan_idx,	\
				   rb, sb, sg)				\
{									\
	.type = chan_type,						\
	.modified = mod,						\
