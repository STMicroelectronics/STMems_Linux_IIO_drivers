...
#define ST_LSM6DSO_REG_ROUNDING_MASK		0x60

#define ST_LSM6DSO_REG_CTRL9_XL_ADDR		0x18
#define ST_LSM6DSO_REG_I3C_DISABLE_MASK		BIT(1)
...
#define ST_LSM6DSO_REG_FIFO_STATUS_DIFF		0x2ff
...
#define ST_LSM6DSO_REG_TAP_X_EN_MASK		BIT(3)
#define ST_LSM6DSO_REG_TAP_Y_EN_MASK		BIT(2)
#define ST_LSM6DSO_REG_TAP_Z_EN_MASK		BIT(1)
...
#define ST_LSM6DSO_EVENT_CHANNEL(ctype, etype, edir)			\
{									\
	.type = ctype,							\
	.modified = 0,							\
	.scan_index = -1,						\
...
#define ST_LSM6DSO_EF_DATA_CHANNEL(chan_type, mod, ch2, scan_idx,	\
				   rb, sb, sg)				\
{									\
	.type = chan_type,						\
	.modified = mod,						\
...
enum st_lsm6dso_suspend_resume_register {
	ST_LSM6DSO_CTRL1_XL_REG = 0,
	...
	ST_LSM6DSO_SUSPEND_RESUME_REGS,
};

struct st_lsm6dso_suspend_resume_entry {
	u8 addr;
	u8 val;
	u8 mask;
};
...
int st_lsm6dso_reset_hwts(struct st_lsm6dso_hw *hw);
#endif /* ST_LSM6DSO_H */
