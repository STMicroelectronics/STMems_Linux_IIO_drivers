...
static const struct iio_chan_spec st_lsm6dso_acc_channels[] = {
	...
	ST_LSM6DSO_EVENT_CHANNEL(IIO_ACCEL, IIO_EV_TYPE_FIFO_FLUSH,
				 IIO_EV_DIR_EITHER),
...
static const struct iio_chan_spec st_lsm6dso_gyro_channels[] = {
	...
	ST_LSM6DSO_DATA_CHANNEL(IIO_ANGL_VEL, ST_LSM6DSO_REG_OUTZ_L_G_ADDR,
				1, IIO_MOD_Z, 2, 16, 16, 's'),
	ST_LSM6DSO_EVENT_CHANNEL(IIO_ANGL_VEL, IIO_EV_TYPE_FIFO_FLUSH,
				 IIO_EV_DIR_EITHER),
	IIO_CHAN_SOFT_TIMESTAMP(3),
};
...
static const struct iio_chan_spec st_lsm6dso_step_counter_channels[] = {
	...
	ST_LSM6DSO_EVENT_CHANNEL(IIO_STEP_COUNTER, IIO_EV_TYPE_FIFO_FLUSH,
				 IIO_EV_DIR_EITHER),
...
static const struct iio_chan_spec st_lsm6dso_temp_channels[] = {
	...
	ST_LSM6DSO_EVENT_CHANNEL(IIO_TEMP, IIO_EV_TYPE_FIFO_FLUSH,
				 IIO_EV_DIR_EITHER),
	IIO_CHAN_SOFT_TIMESTAMP(1),
};
...
iio_register_fail:
	...
	if (hw->irq > 0)
		st_lsm6dso_deallocate_buffers(hw);
