...
static const struct iio_chan_spec st_lsm6dsr_acc_channels[] = {
	...
	ST_LSM6DSR_EVENT_CHANNEL(IIO_ACCEL, IIO_EV_TYPE_FIFO_FLUSH,
				 IIO_EV_DIR_EITHER),
...
static const struct iio_chan_spec st_lsm6dsr_gyro_channels[] = {
	...
	ST_LSM6DSR_DATA_CHANNEL(IIO_ANGL_VEL, ST_LSM6DSR_REG_OUTZ_L_G_ADDR,
				1, IIO_MOD_Z, 2, 16, 16, 's'),
	ST_LSM6DSR_EVENT_CHANNEL(IIO_ANGL_VEL, IIO_EV_TYPE_FIFO_FLUSH,
				 IIO_EV_DIR_EITHER),
	IIO_CHAN_SOFT_TIMESTAMP(3),
};
...
static const struct iio_chan_spec st_lsm6dsr_step_counter_channels[] = {
	...
	ST_LSM6DSR_EVENT_CHANNEL(IIO_STEP_COUNTER, IIO_EV_TYPE_FIFO_FLUSH,
				 IIO_EV_DIR_EITHER),
	IIO_CHAN_SOFT_TIMESTAMP(1),
};

static const struct iio_chan_spec st_lsm6dsr_step_detector_channels[] = {
	ST_LSM6DSR_EVENT_CHANNEL(IIO_STEP_DETECTOR, IIO_EV_TYPE_THRESH,
				 IIO_EV_DIR_RISING),
};

static const struct iio_chan_spec st_lsm6dsr_sign_motion_channels[] = {
	ST_LSM6DSR_EVENT_CHANNEL(IIO_SIGN_MOTION, IIO_EV_TYPE_THRESH,
				 IIO_EV_DIR_RISING),
};

static const struct iio_chan_spec st_lsm6dsr_tilt_channels[] = {
	ST_LSM6DSR_EVENT_CHANNEL(IIO_TILT, IIO_EV_TYPE_THRESH,
				 IIO_EV_DIR_RISING),
};
...
static const struct iio_chan_spec st_lsm6dsr_temp_channels[] = {
	...
	ST_LSM6DSR_EVENT_CHANNEL(IIO_TEMP, IIO_EV_TYPE_FIFO_FLUSH,
				 IIO_EV_DIR_EITHER),
	IIO_CHAN_SOFT_TIMESTAMP(1),
};

static const struct iio_chan_spec st_lsm6dsr_glance_channels[] = {
	ST_LSM6DSR_EVENT_CHANNEL(IIO_GESTURE, IIO_EV_TYPE_THRESH,
				 IIO_EV_DIR_RISING),
};
...
iio_register_fail:
	...
	if (hw->irq > 0)
		st_lsm6dsr_deallocate_buffers(hw);
