...
#define ST_LSM6DSR_REG_FIFO_WTM_MASK		0x1ff
#define ST_LSM6DSR_REG_FIFO_WTM8_MASK		BIT(0)

#define ST_LSM6DSR_REG_FIFO_CTRL3_ADDR		0x09
#define ST_LSM6DSR_REG_BDR_XL_MASK		0x0f
#define ST_LSM6DSR_REG_BDR_GY_MASK		0xf0

#define ST_LSM6DSR_REG_FIFO_CTRL4_ADDR		0x0a
#define ST_LSM6DSR_REG_FIFO_MODE_MASK		0x07
#define ST_LSM6DSR_REG_ODR_T_BATCH_MASK		0x30
#define ST_LSM6DSR_REG_DEC_TS_MASK		0xc0
...
#define ST_LSM6DSR_WHOAMI_VAL			0x6c
...
#define ST_LSM6DSR_REG_ROUNDING_MASK		0x60
...
#define ST_LSM6DSR_REG_FIFO_STATUS_DIFF		0x2ff
...
#define ST_LSM6DSR_EVENT_CHANNEL(ctype, etype, edir)			\
{									\
	.type = ctype,							\
	.modified = 0,							\
	.scan_index = -1,						\
...
#define ST_LSM6DSR_EF_DATA_CHANNEL(chan_type, mod, ch2, scan_idx,	\
				   rb, sb, sg)				\
{									\
	.type = chan_type,						\
	.modified = mod,						\
...
#define ST_LSM6DSR_ACC_FS_4G_GAIN	IIO_G_TO_M_S_2(122)
#define ST_LSM6DSR_ACC_FS_8G_GAIN	IIO_G_TO_M_S_2(244)
#define ST_LSM6DSR_ACC_FS_16G_GAIN	IIO_G_TO_M_S_2(488)

#define ST_LSM6DSR_GYRO_FS_250_GAIN	IIO_DEGREE_TO_RAD(8750)
#define ST_LSM6DSR_GYRO_FS_500_GAIN	IIO_DEGREE_TO_RAD(17500)
#define ST_LSM6DSR_GYRO_FS_1000_GAIN	IIO_DEGREE_TO_RAD(35000)
#define ST_LSM6DSR_GYRO_FS_2000_GAIN	IIO_DEGREE_TO_RAD(70000)
#define ST_LSM6DSR_GYRO_FS_4000_GAIN	IIO_DEGREE_TO_RAD(140000)
...
/**
 * struct st_lsm6dsr_sensor - ST IMU sensor instance
...
/**
 * struct st_lsm6dsr_hw - ST IMU MEMS hw instance
						...
						u8 mask, u8 data)
{
	...
	err = __st_lsm6dsr_write_with_mask(hw, ST_LSM6DSR_REG_FUNC_CFG_ACCESS_ADDR,
					   mask, data);
