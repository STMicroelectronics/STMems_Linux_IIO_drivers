...
#define ST_LSM6DSOX_REG_ACCESS_MASK		0xc0

#define ST_LSM6DSOX_REG_FIFO_CTRL1_ADDR		0x07
#define ST_LSM6DSOX_REG_FIFO_CTRL2_ADDR		0x08
#define ST_LSM6DSOX_REG_FIFO_WTM_MASK		0x01ff
#define ST_LSM6DSOX_REG_FIFO_WTM8_MASK		BIT(0)
#define ST_LSM6DSOX_REG_FIFO_STATUS_DIFF	0x03ff

#define ST_LSM6DSOX_REG_FIFO_CTRL3_ADDR		0x09
#define ST_LSM6DSOX_REG_BDR_XL_MASK		0x0f
#define ST_LSM6DSOX_REG_BDR_GY_MASK		0xf0

#define ST_LSM6DSOX_REG_FIFO_CTRL4_ADDR		0x0a
#define ST_LSM6DSOX_REG_FIFO_MODE_MASK		0x07
#define ST_LSM6DSOX_REG_ODR_T_BATCH_MASK	0x30
#define ST_LSM6DSOX_REG_DEC_TS_MASK		0xc0
...
#define ST_LSM6DSOX_REG_SLAVE_NUMOP_MASK	0x07
...
#define ST_LSM6DSOX_EVENT_CHANNEL(ctype, etype, edir)	\
{							\
	.type = ctype,					\
	.modified = 0,					\
	.scan_index = -1,				\
 ...
 */
static inline s64 st_lsm6dsox_get_time_ns(void)
{
	struct timespec ts;
...
int st_lsm6dsox_deallocate_buffers(struct st_lsm6dsox_hw *hw);
