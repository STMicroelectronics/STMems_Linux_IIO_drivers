...
#define LPS22HB_PRESS_HPASCAL_NANO_SCALE	(1000000000UL / \
...
#define LPS22HB_PRESS_FS_AVL_GAIN		LPS22HB_PRESS_HPASCAL_NANO_SCALE
...
#define LPS22HB_SOFT_RESET_MASK			0x04
...
#define LPS22HB_FIFO_ENABLE_ADDR		LPS22HB_CTRL2_ADDR
#define LPS22HB_FIFO_ENABLE_MASK		0x40
...
#define LPS22HB_MAX_FIFO_LENGTH			32
#define LPS22HB_MAX_CHANNEL_SPEC		3
#define LPS22HB_PRESS_CHANNEL_SIZE		3
#define LPS22HB_TEMP_CHANNEL_SIZE		3
#define LPS22HB_EVENT_CHANNEL_SPEC_SIZE		2

#define ST_LPS22HB_FLUSH_CHANNEL(device_type) \
{ \
	.type = device_type, \
	.modified = 0, \
	.scan_index = -1, \
	.indexed = -1, \
	.event_spec = &lps22hb_fifo_flush_event,\
	.num_event_specs = 1, \
}
...
void lps22hb_read_fifo(struct lps22hb_data *cdata, bool check_fifo_len, bool push);
void lps22hb_flush_fifo(struct lps22hb_data *cdata, u8 fifo_src);
